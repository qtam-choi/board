...
@Component
public class Menu0103Impl extends AbstractHpService
{
	@Override
	public Object serviceCallImpl(Map dataMap)
	{
		...
		// Paging 관련 
		if(init.equals("N")) {
			totalCnt = sqlSession.selectOne("ADMIN_MENU01.sel0103DataListCnt", dataMap);
		}
		...
		List dataList = null;
		if(init.equals("N")) {
			dataList = sqlSession.selectList("ADMIN_MENU01.sel0103DataList", dataMap);
		}
