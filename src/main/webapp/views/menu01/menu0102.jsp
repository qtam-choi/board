                        ...
                        <table class="BasicTbl4 Tblink">
                            ...
                            <tr>
		                     ...
		                     <tr onclick="goDetail('${list.biz_cd}', '${list.msg_cd}' , '${list.make_d}', '${list.send_seq}', '${list.instant_seq}', '${list.seq_no}');" >
                                ...
                                <td>${list.biz_cd}</td>
                                <td>${list.mms_bsns_dvcd }</td>
                                <td>${list.src_key }</td>
                                <td><fmt:formatDate value="${list.rst_date}" pattern="yyyy.MM.dd hh:mm:ss" /></td>
                                <td>${list.success_yn }</td>
                                <td>${list.mms_sndg_tmst }</td>
                                <td>${list.mms_rcv_tmst }</td>
                                <td>${list.mms_rdg_tmst }</td>
