                              ...
                              <tr>
                                ...
                                <td colspan="3">
                                    <select class="select1" style="width:160px;" name="searchType">
                                       <option value="usr_nm" <c:if test="${param.searchType == 'usr_nm'}"> selected="selected" </c:if>>사업자명</option>
                        ...
                        <table class="BasicTbl4 Tblink">
                            ...
                            <tr>
		                     ...
		                     <tr>
                                ...
                                <td>${list.snd_tel_no}</td>
                                <td>${list.elctrc_dcmnt_sbjct}</td>
                                
                                
                                <td><fmt:parseDate var="make_d" value="${list.test_date }" pattern="yyyyMMdd" />
                                	<fmt:formatDate value="${test_date}" pattern="yyyy.MM.dd" /></td>
                                <td><fmt:parseDate var="open_date" value="${list.open_date }" pattern="yyyyMMdd" />
                                	<fmt:formatDate value="${open_date}" pattern="yyyy.MM.dd" /></td>
