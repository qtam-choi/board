...
<script type="text/javascript">
    ...
    <body>
        <div id="Wrap" class="Loginbg">
            <ul>
                <li><img src="<c:url value='/images/kftc_logo.png'/>" alt="시스템 관리자" width="300" height="48"></li>
        ...
        <div class="logincopy" style="bottom:25px;margin-left: -190px;width:350px;width:350px;font-size:15px;font-weight:bold;color:#1E2740">© 2020 ATON Consortium All rights reserved.</div>
    </body>
</html>